...
export default function ActivityTimeline({ taskId }) {
  ...
  if (isLoading) return <p className="text-xs text-gray-500">Loading activity…</p>;
  if (logs.length === 0) return <p className="text-xs text-gray-600">No activity recorded yet.</p>;
